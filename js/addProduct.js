function displaySalesExtraInput() {
    var display = document.forms[0].elements['addProductInputSalesType'];
...
function checkForm() {
    var productID = document.forms['addProductInputForm']['addProductInputProductID'].value;
    var productName = document.forms['addProductInputForm']['addProductInputProductName'].value;
    var originalPrice = document.forms['addProductInputForm']['addProductInputProductOriginalPrice'].value;
    var quantity = document.forms['addProductInputForm']['addProductInputProductQuantity'].value;
    var description = document.forms['addProductInputForm']['addProductInputProductDescription'].value.replace(/\s+/g,' ').replace(/^\s+|\s+$/,'');
    document.forms['addProductInputForm']['addProductInputProductDescription'].value = description;

    var salesType = document.forms['addProductInputForm']['addProductInputSalesType'].value;

    var discount = document.forms['addProductInputForm']['addProductInputSalesDiscount'].value;
    var startDate = document.forms['addProductInputForm']['addProductInputSalesStartDate'].value;
    var endDate = document.forms['addProductInputForm']['addProductInputSalesEndDate'].value;
